...
<table class="table">
    ...
    <tbody>
        ...
        <tr class="tr_{{$key}}">
            ...
            <td>
                <input type="text" class="form-control alphanumeric column_name_{{$key}}" name="column_name[]" value="{{$value->Field}}">
            </td>
            <td>
...
<table class="table">
    <tbody>
        <tr>
            ...
            <td>
                <input type="text" class="form-control alphanumeric" name="new_column_name" id="new_column_name">
            </td>
            <td>
