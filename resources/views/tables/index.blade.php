...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">{{ $title }} - <a href="javascript:void(0)" style="color: red" id="add_new_table">Create New Table</a></div>

                <div class="card-body">
                    <table class="table col-md-12" id="data_table">
                        <thead>
                            <tr>    
                                <th width="60%">Table Name</th>
...
<!-- create tables modal -->
@include('tables/modal/add_modal')

<!-- edit tables modal -->
@include('tables/modal/edit_modal')

<!-- edit columns modal -->
@include('tables/modal/edit_columns_modal')
