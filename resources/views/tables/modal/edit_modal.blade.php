<!-- edit customer modal -->
<div id="modal_edit_table" class="modal fade" role="dialog">
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            ...
            <form method="POST" id="table_edit_form" onsubmit="return false">
                @csrf
                <div class="modal-body">
                    <div class="form-group row">
                        <label for="name" class="col-md-4 col-form-label text-md-right">Table Name</label>
                        <div class="col-md-6">
                            <input type="text" class="form-control alphanumeric edit_table_name" name="table_name" id="table_name">
